...
export default function HeroSection() {
  return (
    <section
      className={`w-full py-12 md:py-32 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-gray-900 dark:to-indigo-950 ${mons.className}`}
    >
      <div className="container px-4 md:px-6 mx-auto max-w-6xl">
        <div className="text-center space-y-8">
          ...
          <p className="text-xl text-gray-700 dark:text-gray-300 max-w-[800px] mx-auto leading-relaxed">
            Revolutionizing legal research with advanced LLMs, blockchain
            integration, and multi-lingual support for faster, more accurate
            justice delivery.
          </p>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-3xl mx-auto">
            <FeatureItem
              icon={<BarChart2 className="h-6 w-6" />}
              text="Intelligent Case Analysis"
            />
            <FeatureItem
              icon={<BookOpen className="h-6 w-6" />}
              text="Comprehensive Legal Database"
            />
            <FeatureItem
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 mt-4">
            Developed for Smart India Hackathon 2024 | Problem Statement ID:
            SIH1701
          </p>
        </div>
      </div>
